...
**残っている項目: TODO-034、TODO-035、TODO-036、TODO-037。** これまでに 33 件を決着させた。
...
スライド 13 の ccstatusline の実例。powerline 風の区切りの SVG が
`h-[1.2cqw]` 固定で帯より短く、**上下に段差ができて三角の先も潰れている**。
高さを帯に合わせて段差をなくす。**色・文字・並びは変えない。**

確認はスクリーンショットで、PC 幅と横持ちスマホ幅の両方を見る。
